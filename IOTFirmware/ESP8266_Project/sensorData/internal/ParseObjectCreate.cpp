...
ParseResponse ParseObjectCreate::send() {
	...
	//return Parse.sendRequest("POST", httpPath, requestBody, "https://parseapi.back4app.com/classes/IoTDemo");
	return Parse.sendRequest("POST", httpPath, requestBody, "");
}

ParseResponse ParseObjectCreate::getResponse(){
	return Parse.getResponseCB();
}