...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/examples/Process/Process.ino 

INO_DEPS += \
./Bridge/examples/Process/Process.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/examples/Process/Process.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/examples/Process/Process.ino
	@echo 'Building file: $<'
