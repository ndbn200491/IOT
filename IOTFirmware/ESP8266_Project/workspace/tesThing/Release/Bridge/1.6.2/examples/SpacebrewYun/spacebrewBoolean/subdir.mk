...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/SpacebrewYun/spacebrewBoolean/spacebrewBoolean.ino 

INO_DEPS += \
./Bridge/1.6.2/examples/SpacebrewYun/spacebrewBoolean/spacebrewBoolean.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/1.6.2/examples/SpacebrewYun/spacebrewBoolean/spacebrewBoolean.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/SpacebrewYun/spacebrewBoolean/spacebrewBoolean.ino
	@echo 'Building file: $<'
