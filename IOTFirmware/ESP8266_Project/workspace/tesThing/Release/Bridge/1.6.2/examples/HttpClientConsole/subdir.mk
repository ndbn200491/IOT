...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/HttpClientConsole/HttpClientConsole.ino 

INO_DEPS += \
./Bridge/1.6.2/examples/HttpClientConsole/HttpClientConsole.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/1.6.2/examples/HttpClientConsole/HttpClientConsole.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/HttpClientConsole/HttpClientConsole.ino
	@echo 'Building file: $<'
