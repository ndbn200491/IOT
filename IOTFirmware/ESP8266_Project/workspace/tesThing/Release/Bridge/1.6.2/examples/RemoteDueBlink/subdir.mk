...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/RemoteDueBlink/RemoteDueBlink.ino 

INO_DEPS += \
./Bridge/1.6.2/examples/RemoteDueBlink/RemoteDueBlink.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/1.6.2/examples/RemoteDueBlink/RemoteDueBlink.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/RemoteDueBlink/RemoteDueBlink.ino
	@echo 'Building file: $<'
