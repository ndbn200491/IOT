...
public class HelpFragment extends Fragment {
    ...
    private static final String FEEDBACK_EMAIL = "mail@.org";
    private static final String FEEDBACK_SUBJECT = " Android Sample Feedback";
    ...
    private static final String TURA_WEBSITE = "http://greentura.com";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        websiteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i(TAG, "Opening Web Browser to greentura Website");
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(TURA_WEBSITE));
