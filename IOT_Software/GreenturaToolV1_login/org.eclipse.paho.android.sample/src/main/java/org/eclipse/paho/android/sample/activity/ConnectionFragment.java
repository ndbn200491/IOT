...
public class ConnectionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTabHost.addTab(mTabHost.newTabSpec("Control").setIndicator("Control"), PublishFragment.class, bundle);
        mTabHost.addTab(mTabHost.newTabSpec("Sensor").setIndicator("Sensor"), SubscriptionFragment.class, bundle);
        return rootView;
