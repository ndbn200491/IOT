...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/WiFiStatus/WiFiStatus.ino 

INO_DEPS += \
./Bridge/1.6.2/examples/WiFiStatus/WiFiStatus.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/1.6.2/examples/WiFiStatus/WiFiStatus.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/WiFiStatus/WiFiStatus.ino
	@echo 'Building file: $<'
