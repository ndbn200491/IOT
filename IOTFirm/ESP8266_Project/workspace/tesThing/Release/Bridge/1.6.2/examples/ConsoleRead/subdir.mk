...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/ConsoleRead/ConsoleRead.ino 

INO_DEPS += \
./Bridge/1.6.2/examples/ConsoleRead/ConsoleRead.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/1.6.2/examples/ConsoleRead/ConsoleRead.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/ConsoleRead/ConsoleRead.ino
	@echo 'Building file: $<'
