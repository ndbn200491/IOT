...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/YunFirstConfig/YunFirstConfig.ino 

INO_DEPS += \
./Bridge/1.6.2/examples/YunFirstConfig/YunFirstConfig.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/1.6.2/examples/YunFirstConfig/YunFirstConfig.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/YunFirstConfig/YunFirstConfig.ino
	@echo 'Building file: $<'
