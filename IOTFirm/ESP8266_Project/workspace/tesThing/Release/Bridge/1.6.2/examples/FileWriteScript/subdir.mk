...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/FileWriteScript/FileWriteScript.ino 

INO_DEPS += \
./Bridge/1.6.2/examples/FileWriteScript/FileWriteScript.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/1.6.2/examples/FileWriteScript/FileWriteScript.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/FileWriteScript/FileWriteScript.ino
	@echo 'Building file: $<'
