...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/Process/Process.ino 

INO_DEPS += \
./Bridge/1.6.2/examples/Process/Process.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/1.6.2/examples/Process/Process.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/Process/Process.ino
	@echo 'Building file: $<'
