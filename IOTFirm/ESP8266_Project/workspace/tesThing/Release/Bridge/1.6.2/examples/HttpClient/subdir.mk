...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/HttpClient/HttpClient.ino 

INO_DEPS += \
./Bridge/1.6.2/examples/HttpClient/HttpClient.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/1.6.2/examples/HttpClient/HttpClient.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/1.6.2/examples/HttpClient/HttpClient.ino
	@echo 'Building file: $<'
