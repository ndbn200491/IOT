...
INO_SRCS += \
C:/eclipseArduino/arduinoPlugin/libraries/Bridge/examples/MailboxReadMessage/MailboxReadMessage.ino 

INO_DEPS += \
./Bridge/examples/MailboxReadMessage/MailboxReadMessage.ino.d 


# Each subdirectory must supply rules for building sources it contributes
Bridge/examples/MailboxReadMessage/MailboxReadMessage.o: C:/eclipseArduino/arduinoPlugin/libraries/Bridge/examples/MailboxReadMessage/MailboxReadMessage.ino
	@echo 'Building file: $<'
